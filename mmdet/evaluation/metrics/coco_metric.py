...
class CocoMetric(BaseMetric):
    ...
    Args:
        ann_file (str, optional): Path to the coco format annotation file.
            If not specified, ground truth annotations from the Data will
    ...
    def __init__(self,
        ...
        # initialize coco api with the converted Data
    ...
    def fast_eval_recall(self,
        ...
        Args:
            results (List[dict]): Results of the Data.
        ...
        for idx, result in enumerate(results):
            ...
            for i in range(len(bboxes)):
                ...
                if isinstance(label, torch.Tensor):
                    ...
                    label_int = int(label)
                if label_int < 0 or label_int >= len(self.cat_ids):
                    continue
                data = dict()
                data['image_id'] = image_id
                data['bbox'] = self.xyxy2xywh(bboxes[i])
                data['score'] = float(scores[i])
                data['category_id'] = self.cat_ids[label_int]
    ...
    def gt_to_coco_json(self, gt_dicts: Sequence[dict],
        ...
        Args:
            gt_dicts (Sequence[dict]): Ground truth of the Data.
            outfile_prefix (str): The filename prefix of the json files. If the
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            try:
                ...
                logger.error(
                    'The testing results of the whole Data is empty.')
                break
