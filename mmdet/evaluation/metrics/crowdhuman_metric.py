    ...
    def eval_ap(score_list, gt_num, img_num):
        ...
        Args:
            score_list(list[tuple[ndarray, int, str]]): Matching result.
                a list of tuples (dtbox, label, imgID) in the descending
                sort of dtbox.score.
            gt_num(int): The number of gt boxes in the entire Data.
            img_num(int): The number of images in the entire Data.
    ...
    def eval_mr(self, score_list, gt_num, img_num):
        ...
        Args:
            score_list(list[tuple[ndarray, int, str]]): Matching result.
                ...
                sort of dtbox.score.
            gt_num(int): The number of gt boxes in the entire Data.
            img_num(int): The number of image in the entire Data.
