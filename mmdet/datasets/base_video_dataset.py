...
class BaseVideoDataset(BaseDataset):
    """Base video Data for VID, MOT and VIS tasks."""

    META = dict(classes=None)
    # ann_id is unique in coco Data.
    ANN_ID_UNIQUE = True
    ...
    def parse_data_info(self, raw_data_info: dict) -> dict:
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('instance_id', None):
                ...
                # image Data usually has no `instance_id`.
    ...
    def prepare_data(self, idx) -> Any:
        ...
        video index in default since the base element of video Data is a
    ...
    def get_cat_ids(self, index) -> List[int]:
        ...
        Args:
            index: The index of the Data. It support two kinds of inputs:
                Tuple:
    ...
    def num_all_imgs(self):
        """Get the number of all the images in this video Data."""
        return sum(
