...
class Resize(MMCV_Resize):
    ...
    Args:
        ...
        clip_object_border (bool): Whether to clip the objects
            outside the border of the image. In some Data like MOT17, the gt
...
class Expand(BaseTransform):
    ...
    Args:
        mean (sequence): mean value of Data.
...
class Mosaic(BaseTransform):
    ...
    .. code:: text
     ...
     The mosaic transform steps are as follows:
         ...
         2. Get the left top image according to the index, and randomly
            sample another 3 images from the custom Data.
    ...
    Args:
        ...
        bbox_clip_border (bool, optional): Whether to clip the objects outside
            the border of the image. In some Data like MOT17, the gt bboxes
    ...
    def get_indexes(self, dataset: BaseDataset) -> int:
        ...
        Args:
            dataset (:obj:`MultiImageMixDataset`): The Data.
...
class MixUp(BaseTransform):
    ...
    .. code:: text
     ...
     The mixup transform steps are as follows:
        ...
        1. Another random image is picked by Data and embedded in
...
class RandomAffine(BaseTransform):
    ...
    Args:
        ...
        border (tuple[int]): Distance from width and height sides of input
            image to adjust output shape. Only used in mosaic Data.
            Defaults to (0, 0).
