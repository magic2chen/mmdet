...
class MultiImageMixDataset:
    """A wrapper of multiple images mixed Data.
    ...
    Args:
        dataset (:obj:`CustomDataset`): The Data to be mixed.
    ...
    def metainfo(self) -> dict:
        """Get the meta information of the multi-image-mixed Data.

        Returns:
            dict: The meta information of multi-image-mixed Data.
        """
        return copy.deepcopy(self._metainfo)

    def full_init(self):
        """Loop to ``full_init`` each Data."""
        ...
        for (transform, transform_type) in zip(self.pipeline,
            ...
            if hasattr(transform, 'get_indexes'):
                for i in range(self.max_refetch):
                    ...
                    # of the original Data is not None.
                    ...
                    raise RuntimeError(
                        'The loading pipeline of the original Data'
                        ' always return None. Please check the correctness '
                        'of the Data and its pipeline.')
            ...
            for i in range(self.max_refetch):
                ...
                raise RuntimeError(
                    'The training pipeline of the Data wrapper'
                    ' always return None.Please check the correctness '
                    'of the Data and its pipeline.')
...
class ConcatDataset(MMENGINE_ConcatDataset):
    """A wrapper of concatenated Data.

    Same as ``torch.utils.data.Data.ConcatDataset``, support
    ...
    Note:
        ...
        sub-Data which conflicts with original Data. If you want to use
        a sub-Data of ``ConcatDataset``, you should set ``indices``
        arguments for wrapped Data which inherit from ``BaseDataset``.
    ...
    Args:
        ...
        ignore_keys (List[str] or str): Ignore the keys that can be
            unequal in `Data.metainfo`. Defaults to None.
    ...
    def __init__(self,
        ...
        # of the first Data, else the metainfo is a list with metainfo
        # of all the datasets
        is_all_same = True
