...
class BaseSegDataset(BaseDataset):
    """Custom Data for semantic segmentation. An example of file structure
    is as followed.
    ...
    Args:
        ...
        metainfo (dict, optional): Meta information for Data, such as
        ...
        indices (int or Sequence[int], optional): Support using first few
            ...
            Data. Defaults to None which means using all ``data_infos``.
        ...
        lazy_init (bool, optional): Whether to load annotation during
            ...
            information of the Data is needed, which is not necessary to
    ...
    def __init__(self,
        ...
        # Full initialize the Data.
        if not lazy_init:
            self.full_init()

        if test_mode:
            assert self._metainfo.get('classes') is not None, \
                'Data metainfo `classes` should be specified when testing'
    ...
    def _update_palette(self) -> list:
        ...
        Returns:
            Sequence: Palette for current Data.
        """
    ...
    def load_data_list(self) -> List[dict]:
        ...
        Returns:
            list[dict]: All data info of Data.
        """
        data_list = []
