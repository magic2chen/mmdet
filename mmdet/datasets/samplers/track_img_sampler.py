...
class TrackImgSampler(Sampler):
    ...
    requires a large amount of memory (>=20G on MOTChallenge17 Data), which
    ...
    def __init__(
        ...
        self.indices = []
        # Hard code here to handle different Data wrapper
        if isinstance(self.dataset, ConcatDataset):
            ...
            'Data wrapper: ClassBalancedDataset and ConcatDataset, but '
