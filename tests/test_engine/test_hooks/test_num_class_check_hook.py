...
class TestNumClassCheckHook(TestCase):
    ...
    def test_before_train_epch(self):
        ...
        # Test when Data.metainfo['classes'] is None
        ...
        # Test when Data.metainfo['classes'] is a str
        ...
        # Test `num_classes` of model is compatible with Data
        runner.model = self.valid_model
        self.hook.before_train_epoch(runner)
        # Test `num_classes` of model is not compatible with Data
