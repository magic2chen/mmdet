...
# This script converts MOT Data into ReID Data.
# Official website of the MOT Data: https://motchallenge.net/
#
# Label format of MOT Data:
#   GTs:
...
#   into the Data for reid model training.
import argparse
import os
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert MOT Data into ReID Data.')
    parser.add_argument('-i', '--input', help='path of MOT data')
    parser.add_argument('-o', '--output', help='path to save ReID Data')
    parser.add_argument(
        '--val-split',
        type=float,
        default=0.2,
        help='proportion of the validation Data to the whole ReID Data')
    parser.add_argument(
        '--vis-threshold',
        type=float,
        default=0.3,
