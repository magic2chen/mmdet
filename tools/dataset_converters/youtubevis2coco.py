...
def convert_vis(ann_dir, save_dir, dataset_version, mode='train'):
    """Convert YouTube-VIS Data in COCO style.

    Args:
        ann_dir (str): The path of YouTube-VIS Data.
        save_dir (str): The path to save `VIS`.
        dataset_version (str): The version of Data. Options are '2019',
            '2021'.
        mode (str): Convert train Data or validation Data or test
            Data. Options are 'train', 'valid', 'test'. Default: 'train'.
    """
