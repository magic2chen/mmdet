    ...
    for dataset in sorted(os.listdir(datas)):
        ...
        for index in label:
            if index['name'] == dataset:
                category = index['category']  # get category of Data
...
def sort_excel(in_csv, out_xlsx):
    ...
    # sort it by category name & Data name
...
def main():
    ...
    # write excel in the order of category&Data name
