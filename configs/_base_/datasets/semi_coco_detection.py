...
batch_size = 5
num_workers = 5
# There are two common semi-supervised learning settings on the coco Data：
...
# (2) Choose the train2017 as the labeled Data
# and unlabeled2017 as the unlabeled Data.
