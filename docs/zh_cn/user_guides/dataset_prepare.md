...
```shell
python tools/misc/download_dataset.py --Data-name coco2014 --unzip
```
...
```shell
python tools/misc/download_dataset.py --Data-name refcoco --save-dir data/coco --unzip
```
...
```shell
python tools/misc/download_dataset.py --Data-name ade20k_2016 --save-dir data --unzip
```
...
mim download mmdet --Data voc2007

# download voc2012 and preprocess by MIM
mim download mmdet --Data voc2012

# download coco2017 and preprocess by MIM
mim download mmdet --Data coco2017
```
