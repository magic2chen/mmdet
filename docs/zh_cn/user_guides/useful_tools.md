...
```shell
python tools/misc/download_dataset.py --Data-name coco2017
python tools/misc/download_dataset.py --Data-name voc2007
python tools/misc/download_dataset.py --Data-name lvis
```
