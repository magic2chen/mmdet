...
CUDA_VISIBLE_DEVICES=0 python tools/test.py \
    ...
    ${CHECKPOINT_FILE} \
    --cfg-options \
    test_dataloader.Data.ann_file=annotations/panoptic_image_info_test-dev2017.json \
    test_dataloader.Data.data_prefix.img=test2017 \
    test_dataloader.Data.data_prefix._delete_=True \
